...
class Player(Character):
    ...
    def __init__(self, name, hp, power, occupation, alive, exp, max_exp):
        self.exp = exp
        self.max_exp = max_exp
        self.occupation = occupation  # ??
        super().__init__(name, hp, power, alive)
    ...
    def attack(self, other):
        ...
        if other.hp <= 0:
            ...
            death_exp = 50
            print(
                f'{Colors.RED}{other.name}{Colors.RESET}이(가) 쓰러졌습니다  {Colors.BRIGHT_YELLOW}{gold_m}gold{Colors.RESET}와 {Colors.BRIGHT_YELLOW}{death_exp}exp{Colors.RESET}를 획득했습니다!')
...
class Monster(Character):
    def __init__(self, name, hp, power, alive):  # monster_death_exp 랜덤으로?
        super().__init__(name, hp, power, alive)
